...
It most be noted that since most practical problems involve very large search spaces, 
it is often not computationally feasible to find the optimal solution.
...
In this section, an example is used to demonstrate its usage.
...
\citep{koza1992chapter10, Ferreira2006Chapter6, langley1987heuristics}.
